...
use CleanCode\PHPUnit\IntermediateVersion;
use PHPUnit\Framework\TestCase;

class IntermediateVersionTest extends TestCase
{
    public function testMessage(): void
    {
        $compact = new IntermediateVersion(0, 'b', 'c');
    ...
    {
        $compact = new IntermediateVersion(1, 'ba', 'bc');
    ...
    {
        $compact = new IntermediateVersion(1, 'ab', 'cb');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new IntermediateVersion(1, 'ab', 'ab');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new IntermediateVersion(0, 'abc', 'adc');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new IntermediateVersion(1, 'abc', 'adc');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new IntermediateVersion(1, 'abcde', 'abfde');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new IntermediateVersion(2, 'ab', 'abc');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new IntermediateVersion(0, 'bc', 'abc');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new IntermediateVersion(2, 'bc', 'abc');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new IntermediateVersion(0, 'abc', 'abbc');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new IntermediateVersion(2, 'abc', 'abbc');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new IntermediateVersion(0, 'abcdde', 'abcde');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new IntermediateVersion(2, 'abcdde', 'abcde');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new IntermediateVersion(0, 'a', null);
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new IntermediateVersion(2, 'a', null);
        $failure = $compact->compact((string)null);
        $this->assertEquals('expected:<a> but was:<null>', $failure);
    }
    ...
    {
        $compact = new IntermediateVersion(0, null, 'a');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new IntermediateVersion(2, null, 'a');
        $failure = $compact->compact((string)null);
        $this->assertEquals('expected:<null> but was:<a>', $failure);
    }
    ...
    {
        $compact = new IntermediateVersion(10, 'S&P500', '0');
        $failure = $compact->compact((string)null);
