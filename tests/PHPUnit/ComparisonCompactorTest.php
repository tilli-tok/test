...
use CleanCode\PHPUnit\ComparisonCompactor;
...
class ComparisonCompactorTest extends TestCase
{
    ...
    {
        $compact = new ComparisonCompactor(0, 'b', 'c');
    ...
    {
        $compact = new ComparisonCompactor(1, 'ba', 'bc');
    ...
    {
        $compact = new ComparisonCompactor(1, 'ab', 'cb');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new ComparisonCompactor(1, 'ab', 'ab');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new ComparisonCompactor(0, 'abc', 'adc');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new ComparisonCompactor(1, 'abc', 'adc');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new ComparisonCompactor(1, 'abcde', 'abfde');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new ComparisonCompactor(2, 'ab', 'abc');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new ComparisonCompactor(0, 'bc', 'abc');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new ComparisonCompactor(2, 'bc', 'abc');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new ComparisonCompactor(0, 'abc', 'abbc');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new ComparisonCompactor(2, 'abc', 'abbc');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new ComparisonCompactor(0, 'abcdde', 'abcde');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new ComparisonCompactor(2, 'abcdde', 'abcde');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new ComparisonCompactor(0, 'a', null);
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new ComparisonCompactor(2, 'a', null);
        $failure = $compact->compact((string)null);
        $this->assertEquals('expected:<a> but was:<null>', $failure);
    }
    ...
    {
        $compact = new ComparisonCompactor(0, null, 'a');
        $failure = $compact->compact((string)null);
    ...
    {
        $compact = new ComparisonCompactor(2, null, 'a');
        $failure = $compact->compact((string)null);
        $this->assertEquals('expected:<null> but was:<a>', $failure);
    }
    ...
    {
        $compact = new ComparisonCompactor(10, 'S&P500', '0');
        $failure = $compact->compact((string)null);
